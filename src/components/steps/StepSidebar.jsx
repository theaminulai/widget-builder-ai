 ...
 */
const stepsList = [
	{ id: SETUP_STEPS.WIDGET_TITLE, label: 'Widget Title', icon: Type, stepNumber: 1 },
	{ id: SETUP_STEPS.WIDGET_ICON, label: 'Widget Icon', icon: Image, stepNumber: 2 },
	{ id: SETUP_STEPS.WIDGET_CATEGORY, label: 'Widget Category', icon: FolderKanban, stepNumber: 3 },
	{ id: SETUP_STEPS.JS_LIBRARY, label: 'JS Library', icon: Library, stepNumber: 4 },
];
					...
					return (
						<motion.button
							...
							className={`step-item ${isActive ? 'active' : ''
								} ${isCompleted ? 'completed' : ''} ${!isAccessible ? 'disabled' : ''
								}`}
